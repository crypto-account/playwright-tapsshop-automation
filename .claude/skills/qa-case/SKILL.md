...
- `Dane testowe` — patrz `.claude/skills/qa-case/columns.md` sekcja Dane testowe (dla wyszukiwarek/filtrów z alternatywami: explicit label „X używana w krokach: 'val'; alternatywy do exploratory: 'val2', 'val3'"; Kroki referencują przez „wpisz frazę z Dane testowe ('val')")
